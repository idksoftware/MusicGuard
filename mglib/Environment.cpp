...
namespace simplearchive {
	...
	void Environment::setEnvironment() {
		...
		setEnv.insert(setEnv.end(), EnvItem(EXTERNAL_COMMAND_LINE_LABEL, config.getExifCommandLine()));
		setEnv.insert(setEnv.end(), EnvItem(EXIF_MAP_PATH_LABEL, config.getExifMapPath()));
		setEnv.insert(setEnv.end(), EnvItem(EXIF_MAP_FILE_LABEL, config.getExifMapFile()));
		setEnv.insert(setEnv.end(), EnvItem(EXIF_TOOL_LABEL, config.getExifToolFile()));
		setEnv.insert(setEnv.end(), EnvItem(EXIF_TOOL_PATH_LABEL, config.getExifToolPath()));
