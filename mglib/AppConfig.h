...
#define WORKSPACE_CHECKOUT_LABEL			"WorkspaceOn"
#define USERSPACE_AUTO_LABEL			"UserspaceOn"
#define WORKSPACE_AUTO_CHECKOUT_LABEL			"AutoCheckoutOn"
...
namespace simplearchive {
	...
	*/
	...
	private:
		...
		static bool m_exifToolEnabled;			// External Exif Tool Enabled
		...
		/// External Exif tool
		static std::string m_exifToolFile;
		static std::string m_exifToolPath;
		/// External Exif Command line
		static std::string m_exifCommandLine;
	...
	public:
		...
		const char *getExifCommandLine();
		const char *getExifToolPath();
		/// @brief gets external Exif tool
		const char *getExifToolFile();
		...
		/// that maps exiftool keywords to Simple Archive keywords.
		bool isExifToolEnabled() { return m_exifToolEnabled; }
