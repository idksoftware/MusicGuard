...
#define DEFAULT_HOME_PATH		   "/IDK-Software/MusicGuard"

constexpr auto IMGARCHIVE_HOME = "MUSICGUARD_HOME";
constexpr auto IMGA_USERSPACE = "MGA_USERSPACE";
constexpr auto IMGA_HIDDEN_USERSPACE = "MGA_HIDDEN_USERSPACE";
constexpr auto IMGA_WORKSPACE = "MGA_WORKSPACE";
constexpr auto IMGA_METADATA = "MGA_METADATA";
constexpr auto IMGA_WORKSPACE_ENABLE = "MGA_WORKSPACE_ENABLE";
constexpr auto IMGA_WORKSPACE_CHKOUT = "MGA_WORKSPACE_CHKOUT";
constexpr auto IMGA_PICTURE = "MGA_PICTURE";
constexpr auto IMGA_PICTURE_ENABLE = "MGA_PICTURE_ENABLE";
constexpr auto IMGA_WWWIMAGE = "MGA_WWWIMAGE";
constexpr auto IMGA_WWWIMAGE_ENABLE = "MGA_WWWIMAGE_ENABLE";
constexpr auto IMGA_MASTER = "MGA_MASTER";
constexpr auto IMGA_DERIVATIVE = "MGA_DERIVATIVE";
constexpr auto IMGA_MASTER_BACKUP1 = "MGA_MASTER_BACKUP1";
constexpr auto IMGA_MASTER_BACKUP2 = "MGA_MASTER_BACKUP2";
constexpr auto IMGA_MASTER_BACKUP1_ENABLE = "MGA_MASTER_BACKUP1_ENABLE";
constexpr auto IMGA_MASTER_BACKUP2_ENABLE = "MGA_MASTER_BACKUP2_ENABLE";
constexpr auto IMGA_DERIVATIVE_BACKUP1 = "MGA_DERIVATIVE_BACKUP1";
constexpr auto IMGA_DERIVATIVE_BACKUP2 = "MGA_DERIVATIVE_BACKUP2";
constexpr auto IMGA_DERIVATIVE_BACKUP1_ENABLE = "MGA_DERIVATIVE_BACKUP1_ENABLE";
constexpr auto IMGA_DERIVATIVE_BACKUP2_ENABLE = "MGA_DERIVATIVE_BACKUP2_ENABLE";
...
constexpr auto DEFAULT_ALLUSER_HOME_PATH = "/IDK-Software/MusicGuard";
constexpr auto DEFAULT_ALLUSER_WWWIMAGE_PATH = "/IDK-Software/MusicGuard/IAWWWPictures";
constexpr auto DEFAULT_ALLUSER_PICTURE_PATH = "/MusicGuard/Pictures";
constexpr auto DEFAULT_ALLUSER_WORKSPACE_PATH = "/MusicGuard/Workspace";
constexpr auto DEFAULT_ALLUSER_MASTER_PATH = "/master";
constexpr auto DEFAULT_ALLUSER_DERIVATIVE_PATH = "/derivative";

#ifdef WIN32
constexpr auto DEFAULT_LOCAL_HOME_PATH = "/MusicGuard";
constexpr auto DEFAULT_LOCAL_WWWIMAGE_PATH = "/MusicGuard/WWWPictures";
constexpr auto DEFAULT_LOCAL_PICTURE_PATH = "/MusicGuard/Pictures";
constexpr auto DEFAULT_LOCAL_WORKSPACE_PATH = "/MusicGuard/Workspace";
...
constexpr auto DEFAULT_LOCAL_PICTURE_PATH = "/MusicGuard/Pictures";
constexpr auto DEFAULT_LOCAL_WORKSPACE_PATH = "/MusicGuard/Workspace";
constexpr auto DEFAULT_LOCAL_MASTER_PATH = "/.MusicGuard/master";
constexpr auto DEFAULT_LOCAL_DERIVATIVE_PATH = "/.MusicGuard/derivative";
#endif
